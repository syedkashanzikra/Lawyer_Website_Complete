                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group" id="customer-box">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="bill_from" id="company" value="company" class="form-check-input" checked>
                                            {{ Form::label('company', __('Company'), ['class' => 'form-label']) }}
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="bill_from" id="advocate" value="advocate" class="form-check-input" >
                                    ...
                                    <div class="row flex-column items-end align-items-end">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-icon-user">
                                                    <input type="text" class="form-control" value="{{$invoice_number}}" readonly name="bill_number">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table  mb-0 table-custom-style" data-repeater-list="items"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-end">
                                                            {{ __('Amount') }} <br>
                                                            <small class="text-danger font-weight-bold">{{ __('tax included') }}</small>
                                                        </th>
                                                        <th></th>
                                                        <th></th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group price-input input-group search-form">
                                                                ...
                                                                'form-control ptax ','id'=>'tax' ,'style'=>'width: 72px; !important', 'required' => 'required']) }}
